...
public class DFAState extends State implements Cloneable {
    ...
    /**
     * Constructor takes a name and initializes a DFAState object
    ...
    /**
     * Check if the DFAState is the initial state.
     *
    ...
    /**
     * Set whether or not the DFAState is the initial state.
     *
    ...
    /**
     * Check if the DFAState is a final state.
     *
    ...
    /**
     * Set whether or not the DFAState is a final state.
     *
    ...
    /**
     * Creates and returns a copy of this DFAState instance.
